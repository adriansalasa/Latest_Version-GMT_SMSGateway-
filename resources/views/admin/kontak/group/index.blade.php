                  ...
                  <table class="table table-striped">
                    ...
                    <td><a href="{{route('admin.phonebook')}}?keyword={{$item->name}}">{{$item->name}}</a></td>
                      ...
                      <td>
                        ...
                        <a href="phonebook/import_group/{{ $item->id }}" class="text-info" title="Edit"><i class="fa fa-id-card" ></i> Import kontak ke grup</a>&nbsp; &nbsp; 

                        <a href="group/{{ $item->id }}/edit" class="text-success" title="Edit"><i class="fa fa-edit" ></i> Edit</a>

                        <button type="submit" class="btn btn-link text-danger"><i class="fa fa-trash"></i> Hapus</button>
