                  ...
                  <table class="table table-striped">
                   ...
                   <tr>
                      ...
                      <td>
                        ...
                        {{$data->in_msg}} <a class="ml-2" href="{{url('pesan/inbox/printPDF/'.$data->in_id)}}"> 
                        <button class="btn btn-danger btn-sm">Download</button></a>
                        @else
                        {{$data->in_msg}} <a href="{{url('pesan/inbox/printPDF/'.$data->in_msg)}}"></a>
                        @endif
                      </td>
                    </tr>
