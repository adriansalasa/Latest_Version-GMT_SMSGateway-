...
Route::name('admin.')->prefix('/')->middleware('Login')->group(function() {
    ...
    Route::group(['prefix'=>'kontak/phonebook'], function(){
        ...
        Route::get('import_group/{id}', 'PhonebooksController@import_group')->name('import_group');
        ...
        Route::post('parse_import_group', 'PhonebooksController@parse_import_group')->name('parse_import_group');
